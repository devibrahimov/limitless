        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <div class="section-title mb-0 text-center">
                    <h2 class="page-title">Məllim Panleinə Giriş </h2>
                    <ul class="page-list">
                        <li><a href="/">Ana Səhifə</a></li>
                        <li>Məllim Panleinə Giriş </li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7">
                    <form class="signin-inner" action="{{route('frontend.teacher_signin')}}" method="post">
                        <div class="row">
                    ...
                    <div class="col-12">
                        <a href="#">Şifrənizi unuttunuzsa Admnistrasiya ilə əlaqə saxlayın ? </a>
                        <a href="#"> <strong>Qeydiyyatdan Keç</strong></a>
                    </div>
                </div>
            </div>
        </div>
