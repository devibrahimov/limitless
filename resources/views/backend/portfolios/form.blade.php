        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                <div class="card card-custom example example-compact">
                    @include('backend.includes.form.header', ['page' => 'portfolios'])
                    <form
                        action="{{ $edit === false ? route('backend.portfolios.store') : route('backend.portfolios.update', ['portfolio' => $portfolio->id]) }}"
                        ...
                        <div class="card-body">
                                ...
                                @foreach ($langs as $lang)
                                    <div class="tab-pane fade @if ($loop->first) active show @endif"
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="name:{{ $lang->code }}" type="text"
                                                        ...
                                                        name="name:{{ $lang->code }}"
                                                        value="{{ isset($portfolio) ? $portfolio->translate($lang->code)->name : old('name:' . $lang->code) }}"
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="slug:{{ $lang->code }}" type="text"
                                                        ...
                                                        value="{{ isset($portfolio) ? $portfolio->translate($lang->code)->slug : old('slug:' . $lang->code) }}"
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="title:{{ $lang->code }}" type="text"
                                                        ...
                                                        value="{{ isset($portfolio) ? $portfolio->translate($lang->code)->title : old('title:' . $lang->code) }}"
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="keywords:{{ $lang->code }}" type="text"
                                                        ...
                                                        value="{{ isset($portfolio) ? $portfolio->translate($lang->code)->keywords : old('keywords:' . $lang->code) }}"
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="description:{{ $lang->code }}" type="text"
                                                        ...
                                                        value="{{ isset($portfolio) ? $portfolio->translate($lang->code)->description : old('description:' . $lang->code) }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <textarea class="summernote @if ($errors->has("text:$lang->code")) is-invalid @endif" name="description:{{ $lang->code }}"
                                                        placeholder="@lang('backend.placeholders.enter.content')">
                                                      {!! isset($portfolio) ? $portfolio->translate($lang->code)->text : old('text:' . $lang->code) !!}
                                                   </textarea>`
                                        ...
                                        {{-- <div class="form-group row">
                                            <label for="image_alt:{{ $lang->code }}"
                                                class="col-form-label text-right col-lg-3 col-sm-12">
                                                @lang('backend.labels.image_alt') ({{ strtoupper($lang->code) }})
                                            </label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="image_alt:{{ $lang->code }}" type="text"
                                                        class="form-control @if ($errors->has("image_alt:$lang->code")) is-invalid @endif"
                                                        name="image_alt:{{ $lang->code }}"
                                                        value="{{ isset($portfolio) ? $portfolio->translate($lang->code)->image_alt : old('image_alt:' . $lang->code) }}"
                                                        placeholder="@lang('backend.placeholders.enter.image_alt')">
                                                    @if ($errors->has("image_alt:$lang->code"))
                                                        <div class="invalid-feedback">
                                                            {{ $errors->first("image_alt:$lang->code") }}</div>
                                                    @endif
                                                </div>
                                            </div>
                                        </div> --}}
                            ...
                            <div class="form-group row">
                                <label class="col-form-label text-right col-lg-3 col-sm-12">
                                    @lang('backend.labels.day_count')
                                    <span class="text-danger">*</span>
                                </label>
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        <input id="day_count" type="number"
                                            class="form-control @error('day_count') is-invalid @enderror" name="day_count"
                                            value="{{ isset($portfolio) ? $portfolio->day_count : old('day_count') }}"
                                            placeholder="@lang('backend.placeholders.enter.day_count')">
                                        @error('day_count')
                            ...
                            <div class="form-group row">
                                <label class="col-form-label text-right col-lg-3 col-sm-12">
                                    @lang('backend.labels.page_count')
                                    <span class="text-danger">*</span>
                                </label>
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        <input id="page_count" type="number"
                                            class="form-control @error('page_count') is-invalid @enderror"
                                            name="page_count"
                                            value="{{ isset($portfolio) ? $portfolio->page_count : old('page_count') }}"
                                            placeholder="@lang('backend.placeholders.enter.page_count')">
                                        @error('page_count')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <div class="invalid-feedback d-block">
                                            {{ $errors->has('image') ? $errors->first('image') : $errors->first('image.*') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="input-group">
                                        <select id="category_id" v-model="category_id"
                                            ...
                                            @foreach ($categories as $category)
                                                <option {{ (isset($portfolio->category_id) && $portfolio->category_id == $category->id) ? 'selected' : ''}} value="{{ $category->id }}">
                                                    {{ $category->transname }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <span class="switch switch-md switch-icon">
                                            <label>
                                                <input type="checkbox" class="bool" name="status"
                                                    value="{{ isset($portfolio) ? $portfolio->status : old('status', 1) }}"
                                                    {{ (isset($portfolio) ? $portfolio->status : old('status', 1)) == 1 ? 'checked' : '' }}>
                                                <span></span>
                                            </label>
                                        </span>
                                    </div>
