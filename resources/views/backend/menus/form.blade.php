        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                <div class="card card-custom example example-compact">
                    ...
                    <form action="{{ $edit === false ? route('backend.menus.store') : route('backend.menus.update', ['menu' => $menu->id])  }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if($edit)
                            @method('PUT')
                        @endif
                                ...
                                @foreach ($langs as $lang)
                                    <div class="tab-pane fade @if($loop->first) active show @endif" id="{{ $lang->code }}" role="tabpanel" aria-labelledby="tab-{{ $lang->code }}">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="name:{{ $lang->code }}" type="text" class="form-control @if($errors->has("name:$lang->code")) is-invalid @endif"  name="name:{{ $lang->code }}" value="{{ isset($menu) ? optional($menu->translate($lang->code))->name : old('name:'.$lang->code) }}" placeholder="@lang('backend.placeholders.enter.name')">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="slug:{{ $lang->code }}" type="text" class="form-control @if($errors->has("slug:$lang->code")) is-invalid @endif"name="slug:{{ $lang->code }}" value="{{ isset($menu) ? optional($menu->translate($lang->code))->slug : old('slug:'.$lang->code) }}" placeholder="@lang('backend.placeholders.enter.slug')">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="title:{{ $lang->code }}" type="text" class="form-control @if($errors->has("title:$lang->code")) is-invalid @endif" name="title:{{ $lang->code }}" value="{{ isset($menu) ? optional($menu->translate($lang->code))->title : old('title:'.$lang->code) }}" placeholder="@lang('backend.placeholders.enter.meta_title')">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="keywords:{{ $lang->code }}" type="text" class="form-control tagify-{{ $lang->code }} @if($errors->has("keywords:$lang->code")) is-invalid @endif" name="keywords:{{ $lang->code }}" value="{{ isset($menu) ? optional($menu->translate($lang->code))->keywords : old('keywords:'.$lang->code) }}" placeholder="@lang('backend.placeholders.enter.meta_keywords')">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="description:{{ $lang->code }}" type="text" class="form-control @if($errors->has("description:$lang->code")) is-invalid @endif"  name="description:{{ $lang->code }}" value="{{ isset($menu) ? optional($menu->translate($lang->code))->description : old('description:'.$lang->code) }}" placeholder="@lang('backend.placeholders.enter.meta_description')">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="form-group">
                                        <select name="positions[]" id="positions" class="form-control select2  @error('positions') is-invalid @enderror" multiple>
                                       <option value="header"{{ ($edit && in_array('header',$menu->positions)) ? 'selected' : '' }}>Üst</option>
                                       <option value="footer"{{ ($edit && in_array('footer',$menu->positions)) ? 'selected' : '' }}>Aşağı</option>
                                       <option value="left"{{ ($edit && in_array('left',$menu->positions)) ? 'selected' : '' }}>Sol</option>
                                       <option value="right"{{ ($edit && in_array('right',$menu->positions)) ? 'selected' : '' }}>Sağ</option>
                                   </select>
                                        @error('positions')
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                      <span class="switch switch-md switch-icon">
                                          <label>
                                              <input type="checkbox" class="bool" name="status" value="{{ isset($menu) ? $menu->status : old('status') }}"  {{ (isset($menu) ? old('status',$menu->status) : old('status',1) ) == 1 ? 'checked' : '' }}>
                                              <span></span>
                                          </label>
                                      </span>
                                    </div>
