...
{{--                        <a href="{{ route('backend.events.index') }}" class="menu-link">--}}
{{--                            <span class="svg-icon menu-icon">--}}
{{--                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"--}}
{{--                                    width="24px" height="24px" viewBox="0 0 24 24" version="1.1">--}}
{{--                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
...
{{--                @endcan--}}
                ...
                @endif
                    <li class="menu-item{{ url()->current() == route('backend.videos.index') ? ' menu-item-active' : '' }}"
                        aria-haspopup="true">
                        <a href="{{ route('backend.videos.index') }}" class="menu-link">
                    <span class="svg-icon menu-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                             width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <li class="menu-item{{ url()->current() == route('backend.courses.index') ? ' menu-item-active' : '' }}"
                        aria-haspopup="true">
                    ...
                    <li class="menu-item{{ url()->current() == route('backend.lessons.index') ? ' menu-item-active' : '' }}"
                        aria-haspopup="true">
                        <a href="{{ route('backend.lessons.index') }}" class="menu-link">
                    <span class="svg-icon menu-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                             width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
{{--                @can('teams index')--}}
{{--                    <li class="menu-item{{ url()->current() == route('backend.teams.index') ? ' menu-item-active' : '' }}"--}}
{{--                        aria-haspopup="true">--}}
{{--                        <a href="{{ route('backend.teams.index') }}" class="menu-link">--}}
{{--                            <span class="svg-icon menu-icon">--}}
{{--                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"--}}
{{--                                    width="24px" height="24px" viewBox="0 0 24 24" version="1.1">--}}
{{--                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
...
{{--                @endcan--}}
                ...
                @can('about-block index')
                    <li class="menu-item{{ url()->current() == route('backend.about-block.index') ? ' menu-item-active' : '' }}"
                        aria-haspopup="true">
                        <a href="{{ route('backend.about-block.index') }}" class="menu-link">
                            <span class="svg-icon menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <span class="menu-text">
                                @lang('backend.titles.about-block')
                            </span>
                        </a>
                    </li>
                @endcan
                ...
                @endif
{{--                @if (admin()->can('blogs index'))--}}
                    <li class="menu-item{{ url()->current() == route('backend.teachers.index') ? ' menu-item-active' : '' }}"
                        aria-haspopup="true">
                        <a href="{{ route('backend.teachers.index') }}" class="menu-link">
                            <span class="svg-icon menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <li class="menu-item{{ url()->current() == route('backend.levels.index') ? ' menu-item-active' : '' }}"
                        aria-haspopup="true">
                        <a href="{{ route('backend.levels.index') }}" class="menu-link">
                            <span class="svg-icon menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
{{--                @if (admin()->can('goals index'))--}}
{{--                <li class="menu-item{{ url()->current() == route('backend.goals.index') ? ' menu-item-active' : '' }}"--}}
{{--                    aria-haspopup="true">--}}
{{--                    <a href="{{ route('backend.goals.index') }}" class="menu-link">--}}
{{--                        <span class="svg-icon menu-icon">--}}
{{--                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"--}}
{{--                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">--}}
{{--                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
...
{{--                        </span>--}}
{{--                        <span class="menu-text">--}}
{{--                            @lang('backend.titles.goals')--}}
{{--                        </span>--}}
{{--                    </a>--}}
{{--                </li>--}}
{{--            @endif--}}

{{--                @if (admin()->can('partners index'))--}}
{{--                    <li class="menu-item{{ url()->current() == route('backend.partners.index') ? ' menu-item-active' : '' }}"--}}
{{--                        aria-haspopup="true">--}}
...
{{--                        </span>--}}
{{--                            <span class="menu-text">--}}
{{--                            @lang('backend.titles.partners')--}}
{{--                        </span>--}}
{{--                        </a>--}}
{{--                    </li>--}}
{{--                @endif--}}

{{--            @if (admin()->can('projects index'))--}}
{{--            <li class="menu-item{{ url()->current() == route('backend.projects.index') ? ' menu-item-active' : '' }}"--}}
{{--                aria-haspopup="true">--}}
{{--                <a href="{{ route('backend.projects.index') }}" class="menu-link">--}}
{{--                    <span class="svg-icon menu-icon">--}}
{{--                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"--}}
{{--                            width="24px" height="24px" viewBox="0 0 24 24" version="1.1">--}}
{{--                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
...
{{--        @endif--}}
                ...
                @if (admin()->can('settings index') || admin()->can('languages index') || admin()->can('faqs index') || admin()->can('order-statuses index') || admin()->can('logs index') || admin()->can('system index'))
                                            ...
                                            <ul class="menu-subnav">
                                                @can('logs index')
                                                    <li class="menu-item{{ url()->current() == route('backend.logs.index') ? ' menu-item-active' : '' }}"
                                                        aria-haspopup="true">
                                                        <a href="{{ route('backend.logs.index') }}"
                                                            class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
                                                                <span></span>
                                                            </i>
                                                ...
                                                @can('system index')
                                                    <li class="menu-item{{ url()->current() == route('backend.logs.system') ? ' menu-item-active' : '' }}"
                                                        aria-haspopup="true">
                                                        <a href="{{ route('backend.logs.system') }}"
                                                            class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
                                                                <span></span>
                                                            </i>
